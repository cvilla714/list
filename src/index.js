...
const renderTodos = (project) => {
  ...
  todoArray.forEach((todo) => {
    ...
    if (todo.finished) {
      ...
      li.innerHTML = `<input type='checkbox' id='${projectName}${checkboxId}' class='mr-2 pl-2 ml-2'><span class='${todo.priority.toLowerCase()} ml-1' id='span${projectName}${checkboxId}'><strong>Title:</strong>${todo.title} / <strong>Description:</strong> ${todo.description} / <strong>DueDate:</strong>${todo.date}</span>`;
    }
